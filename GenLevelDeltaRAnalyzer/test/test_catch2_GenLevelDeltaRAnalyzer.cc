...
static constexpr auto s_tag = "[GenLevelDeltaRAnalyzer]";

TEST_CASE("Standard checks of GenLevelDeltaRAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("GenLevelDeltaRAnalyzer"
